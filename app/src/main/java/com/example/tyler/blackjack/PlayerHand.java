...
/**
 * Created by Tyler on 11/20/2014.
 */
public class PlayerHand extends BlackJack {
    ...
    //For when a split occurs, removes the card from the left hand
    protected void removeCard(int index){
        if(aceValue11 != null){
            aceValue11.remove(index);
        }
        aceValue1.remove(index);
    }
